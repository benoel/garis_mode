...
INSERT INTO `products` (`product_id`, `name`, `price`, `stock`, `picture`, `category`, `tag`, `created`) VALUES
	...
	(20, 'BLOUSE-R-LORENA-ST-WHITEBLUE-F', 130000, 4, '11.jpg', 'WOMEN', 'lengan panjang wanita garis', '2016-11-17 10:51:17'),
	(21, 'BLOUSE-R-JOSEPHINE-WHITE-F', 175000, 8, '12.jpg', 'WOMEN', 'josephine putih kaos wanita', '2016-11-17 10:53:56');
