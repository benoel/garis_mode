...
-- Dumping data for table garis_mode.orders: 3 rows
DELETE FROM `orders`;
...
-- Dumping data for table garis_mode.products: 14 rows
...
INSERT INTO `products` (`product_id`, `name`, `price`, `stock`, `picture`, `category`, `tag`, `created`) VALUES
	...
	(22, 'ASHER-SQUA-YELLOW-M', 150000, 10, '13.jpg', 'MEN', 'kemeja pria kotak-kotak ', '2016-11-25 19:09:11'),
...
INSERT INTO `users` (`user_id`, `username`, `password`, `name`, `address`, `phone`, `email`, `active`, `last_login`, `created`) VALUES
	(14, 'fajri', '437eb04136c59d226f14527f52726341', 'alfajri', 'jalan jalan', '08989891121', 'alfajri@gmail.com', 1, '0000-00-00 00:00:00', '2016-11-13 15:58:43'),
	(12, 'azis', 'be1f5695d087aad28f35603dda8719ab', 'ibnu abdul azis', 'jalan duri raya', '08988972981', 'ibnu.a.azis@gmail.com', 1, '2016-11-23 11:59:30', '2016-11-13 15:55:58'),
