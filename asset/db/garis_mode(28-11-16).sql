...
-- Dumping data for table garis_mode.admins: 4 rows
DELETE FROM `admins`;
...
-- Dumping data for table garis_mode.confirmations: 0 rows
...
-- Dumping data for table garis_mode.orderdetails: 0 rows
...
-- Dumping data for table garis_mode.orders: 4 rows
DELETE FROM `orders`;
...
INSERT INTO `orders` (`order_id`, `no_invoice`, `user_id`, `name`, `transfer_to`, `delivery_address`, `delivery_address_2`, `city`, `zip_code`, `phone`, `grand_total`, `code_transfer`, `status`, `order_date`, `expired_date`) VALUES
	...
	(57, 'GRM00004', 12, 'ibnu abdul azis', 'BCA', 'jalan', '', 'jakarta', '12121211', '089898989898', 150000, NULL, 'expired', '2016-11-27 00:10:32', '2016-11-25 22:20:16');
...
INSERT INTO `products` (`product_id`, `name`, `price`, `stock`, `picture`, `category`, `tag`, `created`) VALUES
	...
	(22, 'ASHER-SQUA-YELLOW-M', 150000, 10, '13.jpg', 'MEN', 'kemeja pria kotak-kotak ', '2016-11-27 00:10:33'),
	(23, 'ASHER-SQUA-REDNAVY-M', 175000, 15, '14.jpg', 'MEN', 'kemeja pria kotak-kotak ', '2016-11-25 19:11:34'),
	(24, 'JACKET-I-WILDER-STRIPE-MAROONWHITE-M', 275000, 4, '15.jpg', 'MEN', 'jaket pria garis merah', '2016-11-26 14:05:25'),
	(25, 'SWEATER-I-THEO-NAVJO-RED-M', 255000, 6, '16.jpg', 'MEN', 'sweater merah pria motif', '2016-11-26 14:10:53');
...
-- Dumping data for table garis_mode.users: 3 rows
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`user_id`, `username`, `password`, `name`, `address`, `phone`, `email`, `active`, `last_login`, `created`) VALUES
	(14, 'fajri', '437eb04136c59d226f14527f52726341', 'alfajri', 'jalan jalan', '08989891121', 'alfajri@gmail.com', 1, '2016-11-28 11:05:34', '2016-11-13 15:58:43'),
	(12, 'azis', 'be1f5695d087aad28f35603dda8719ab', 'ibnu abdul azis', 'jalan duri raya', '08988972981', 'ibnu.a.azis@gmail.com', 1, '2016-11-26 14:00:49', '2016-11-13 15:55:58'),
	(18, 'tamam', '8daf4d6ccab84245b60d2ee408e0d88c', 'badrud taman', 'Jalan asem', '087850584166', 'tamam7373@gmail.com', 1, '0000-00-00 00:00:00', '2016-11-22 23:53:07');
