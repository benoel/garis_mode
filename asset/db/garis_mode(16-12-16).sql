...
INSERT INTO `confirmations` (`confirmation_id`, `user_id`, `no_invoice`, `bankname`, `accname`, `noacc`, `message`, `pict`, `status`, `confirmation_date`) VALUES
(16, 12, 'GRM00001', 'BCA', 'ibnu abdul azis', '111122233455555', 'sudah transfer', 'WhatsApp Image 2016-12-07 at 20.31.03 (1).jpeg', 'accepted', '2016-12-16 00:46:22');
/*!40000 ALTER TABLE `confirmations` ENABLE KEYS */;


-- Dumping structure for table u6724920_garmod.discount
...
-- Dumping data for table u6724920_garmod.discount: 1 rows
DELETE FROM `discount`;
/*!40000 ALTER TABLE `discount` DISABLE KEYS */;
INSERT INTO `discount` (`discount_id`, `discount`, `desc`, `limit`, `status`, `created_by`, `created`) VALUES
(1, 10, 'discount akhir tahun', 300000, 1, '1', '2016-12-16 10:47:09');
/*!40000 ALTER TABLE `discount` ENABLE KEYS */;


-- Dumping structure for table u6724920_garmod.expiredtime
CREATE TABLE IF NOT EXISTS `expiredtime` (
...
-- Dumping data for table u6724920_garmod.expiredtime: 0 rows
DELETE FROM `expiredtime`;
/*!40000 ALTER TABLE `expiredtime` DISABLE KEYS */;
/*!40000 ALTER TABLE `expiredtime` ENABLE KEYS */;
...
-- Dumping data for table u6724920_garmod.orderdetails: 2 rows
...
-- Dumping data for table u6724920_garmod.orders: 1 rows
DELETE FROM `orders`;
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT INTO `orders` (`order_id`, `no_invoice`, `user_id`, `name`, `transfer_to`, `delivery_address`, `delivery_address_2`, `city`, `zip_code`, `phone`, `courier`, `service`, `cost_courier`, `grand_total`, `code_transfer`, `status`, `sign_by`, `order_date`, `expired_date`) VALUES
(63, 'GRM00001', 12, 'ibnu abdul azis', 'BCA', 'jalan duri raya', '', 'Jakarta Barat', '111450', '08988972981', 'jne', 'CTC', 9000, 751500, NULL, 'accepted', 1, '2016-12-16 00:46:22', '2016-12-16 00:28:48');
...
-- Dumping data for table u6724920_garmod.products: 16 rows
...
(22, 'ASHER-SQUA-YELLOW-M', 150000, 7, '13.jpg', 'MEN', 'kemeja pria kotak-kotak ', '2016-11-30 13:31:00', NULL, 1, NULL),
(23, 'ASHER-SQUA-REDNAVY-M', 175000, 10, '14.jpg', 'MEN', 'kemeja pria kotak-kotak ', '2016-11-30 13:31:02', NULL, 1, NULL),
...
-- Dumping data for table u6724920_garmod.users: 6 rows
DELETE FROM `users`;
...
(12, 'azis', 'be1f5695d087aad28f35603dda8719ab', 'ibnu abdul azis', 'jalan duri raya', '08988972981', 'ben_oel@yahoo.com', 1, 1, '2016-12-15 23:51:26', '2016-11-13 15:55:58'),
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', NULL, NULL, 'ibnu.a.azis@gmail.com', 3, 1, '2016-12-16 10:34:10', '2016-11-30 11:18:17'),
