...
-- Dumping structure for table garis_mode.discount
...
-- Dumping data for table garis_mode.discount: 1 rows
...
-- Dumping structure for table garis_mode.expiredtime
...
-- Dumping data for table garis_mode.expiredtime: 0 rows
...
-- Dumping data for table garis_mode.orders: 1 rows
DELETE FROM `orders`;
...
INSERT INTO `users` (`user_id`, `username`, `password`, `name`, `address`, `phone`, `email`, `role`, `active`, `last_login`, `created`) VALUES
	...
	(12, 'azis', 'be1f5695d087aad28f35603dda8719ab', 'ibnu abdul azis', 'jalan duri raya', '08988972981', 'ben_oel@yahoo.com', 1, 1, '2016-12-16 13:25:56', '2016-11-13 15:55:58'),
	...
	(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', NULL, NULL, 'ibnu.a.azis@gmail.com', 3, 1, '2017-01-01 23:29:35', '2016-11-30 11:18:17'),
